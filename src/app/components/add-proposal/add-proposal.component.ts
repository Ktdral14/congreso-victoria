...
export class AddProposalComponent implements OnInit {
  ...
  descargarAcusePDF() {
    ...
    let propuesta = JSON.parse(localStorage.getItem('propuesta-' + this.userData.id_usuarios));
    // declaracion pdf
    ...
    if(this.userData.proyectos !== 'No data'){
      // campos
      campo1 = this.userData.proyectos.introduccion;
      campo2 = this.userData.proyectos.objetivos;
      campo3 = this.userData.proyectos.importancia;
      campo4 = this.userData.proyectos.alineacion;
      campo5 = this.userData.proyectos.descripcion;
      campo6 = this.userData.proyectos.identificacion;
      campo7 = this.userData.proyectos.marco;
      campo8 = this.userData.proyectos.etapas;
      campo9 = this.userData.proyectos.experiencia;
      campo10 = this.userData.proyectos.tipificacion;
      campo11 = this.userData.proyectos.impacto;
      campo12 = this.userData.proyectos.factibilidad;
      campo13 = this.userData.proyectos.resultados;
      campo14 = this.userData.proyectos.url;

    } else{
      campo1 = propuesta.introduccion;
      campo2 = propuesta.objetivos;
      campo3 = propuesta.importancia;
      campo4 = propuesta.alineacion;
      campo5 = propuesta.descripcion;
      campo6 = propuesta.identificacion;
      campo7 = propuesta.marco;
      campo8 = propuesta.etapas;
      campo9 = propuesta.experiencia;
      campo10 = propuesta.tipificacion;
      campo11 = propuesta.impacto;
      campo12 = propuesta.factibilidad;
      campo13 = propuesta.resultados;
      campo14 = propuesta.url;
    }
    
    const nomPropuesta = this.userData.propuesta !== 'No data'? this.userData.propuesta.nombre_propuesta: aspirantes.nombre_propuesta;
    const primerAspirante = this.userData.propuesta !== 'No data'? this.userData.propuesta.p_aspirante: aspirantes.p_aspirante;
    const segundoAspirante = this.userData.propuesta !== 'No data'? this.userData.propuesta.s_aspirante: aspirantes.s_aspirante;
    const tercerAspirante = this.userData.propuesta !== 'No data'? this.userData.propuesta.t_aspirante: aspirantes.t_aspirante;
