...
export class AddProposalComponent implements OnInit {
  ...
  descargarAcusePDF() {
    ...
    const nomPropuesta = this.userData.propuesta.nombre_propuesta;
    const primerAspirante = this.userData.propuesta.p_aspirante;
    const segundoAspirante = this.userData.propuesta.s_aspirante;
    const tercerAspirante = this.userData.propuesta.t_aspirante;
